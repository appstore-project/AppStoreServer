...
insert into Aps_App_Comment(id, app_id, user_id, comment_text) values (seq_App_Comment.nextval, 1, 1, 'به نظرم برنامه خوبیه');
insert into Aps_App_Comment(id, app_id, user_id, comment_text) values (seq_App_Comment.nextval, 1, 2, 'از تولید کنندگان برنامه تشکر می کنم');
insert into Aps_App_Comment(id, app_id, user_id, comment_text) values (seq_App_Comment.nextval, 1, 3, 'Great Application. Very thanks');
insert into Aps_App_Comment(id, app_id, user_id, comment_text) values (seq_App_Comment.nextval, 2, 1, 'برنامه کاربردیه ولی خیلی کنده');
