...
insert into aps_category(name) values ('Tools');
insert into aps_category(name) values ('Games');

insert into app (id, title, category_name) values (seq_app_id.nextval, 'NetTest', 'Tools');
insert into app (id, title, category_name) values (seq_app_id.nextval, 'New Galaxy', 'Games');
insert into app (id, title, category_name) values (seq_app_id.nextval, 'Stars War', 'Games');
...
insert into Aps_User(user_id, username, password) values (seq_user_id.nextval, 'erfan', '$2a$10$fw16weS5K06GiuSRtUyt2.jeSQboQtTvV0Vvx8ZsMSuVJHHgTT9TC')
