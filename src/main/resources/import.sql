...
insert into app (id, title, version) values (seq_app_id.nextval, 'test', '1.0');
insert into app (id, title, version) values (seq_app_id.nextval, 'New Galaxy', '2.4');
insert into app (id, title, version) values (seq_app_id.nextval, 'Stars War', '3.1.23');
